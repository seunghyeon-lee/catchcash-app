        ...
        <aside className="w-56 shrink-0 border-r border-[#e5e7eb] bg-white px-3 py-6">
          ...
          <nav aria-label="관리자 메뉴" className="space-y-1">
            {navigation.map((item) => {
              ...
              const active = pathname === item.href || (item.href === "/admin/inquiries" && pathname.startsWith("/admin/inquiries")) || (item.href === "/admin/products" && pathname.startsWith("/admin/products")) || (item.href === "/admin/mappings" && pathname.startsWith("/admin/mappings"));
